...
interface WorkflowState {
  ...
  sidebarOpen: boolean;
  activeRole: string;
  currentView: 'dashboard' | 'manageWorkflows' | 'designer' | 'executor' | 'replay' | 'contextSchema' | 'buckets' | 'bucketHelp' | 'rules' | 'ruleHelp' | 'bucketWorkload' | 'integrations' | 'instances' | 'customerForms' | 'executions' | 'events';
  viewHistory: ('dashboard' | 'manageWorkflows' | 'designer' | 'executor' | 'replay' | 'contextSchema' | 'buckets' | 'bucketHelp' | 'rules' | 'ruleHelp' | 'bucketWorkload' | 'integrations' | 'instances' | 'customerForms' | 'executions' | 'events')[];
  ...
  setView: (view: 'dashboard' | 'manageWorkflows' | 'designer' | 'executor' | 'replay' | 'contextSchema' | 'buckets' | 'bucketHelp' | 'rules' | 'ruleHelp' | 'bucketWorkload' | 'integrations' | 'instances' | 'customerForms' | 'executions' | 'events') => void;
  goBack: () => void;
