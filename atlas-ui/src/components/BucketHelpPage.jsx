...
import { Box, Container, Typography, Button, Card, CardContent, IconButton, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Grid } from '@mui/material';
...
export const BucketHelpPage = ({ onShowNotification }) => {
              ...
              <CardContent sx={{ p: 3 }}>
                ...
                <TableContainer component={Paper} sx={{ bgcolor: 'background.default', border: '1px solid', borderColor: 'divider', borderRadius: 2, boxShadow: 'none' }}>
                  <Table size="small">
                    ...
                    <TableBody>
                      {contextFields.map((row) => (<TableRow key={row.field}>
