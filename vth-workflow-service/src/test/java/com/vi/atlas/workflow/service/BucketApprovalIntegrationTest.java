...
import com.vi.atlas.workflow.scheduler.FormApprovalScheduler;
...
public class BucketApprovalIntegrationTest {
    ...
    public void testBucketEntryAndStatusChange() {
        ...
        Optional<RevertStatus> revertOpt = revertStatusRepository.findByFormIdAndBucketIdAndStatus(formId, "A2", com.vi.atlas.workflow.entity.RevertStepStatus.PENDING);
