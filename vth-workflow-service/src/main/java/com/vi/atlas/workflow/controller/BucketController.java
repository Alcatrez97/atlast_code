...
import com.vi.atlas.common.dto.BucketDto;
import com.vi.atlas.workflow.service.BucketService;
...
public class BucketController {
    ...
    public ResponseEntity<List<com.vi.atlas.common.dto.BucketOutcomeDto>> getOutcomesByBucketId(@PathVariable String bucketId) {
        return bucketService.getBucketByBusinessKey(bucketId)
    ...
    public ResponseEntity<List<com.vi.atlas.common.dto.BucketOutcomeDto>> getOutcomesById(@PathVariable String id) {
        return bucketService.getBucketById(id)
                .map(dto -> ResponseEntity.ok(dto.getPossibleOutcomes()))
                .orElse(ResponseEntity.notFound().build());
    }
