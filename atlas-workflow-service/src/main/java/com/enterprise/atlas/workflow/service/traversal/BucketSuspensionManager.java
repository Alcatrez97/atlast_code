...
import com.enterprise.atlas.workflow.entity.*;
import com.enterprise.atlas.workflow.repository.*;
 ...
 * <ol>
 *   <li>Updates (or creates) the {@link com.enterprise.atlas.workflow.entity.CustomerForm}
...
public class BucketSuspensionManager {
    ...
    public void createBucketRevertStatusAndFormPending(String instanceId,
        ...
        if (formId == null || formId.isBlank()
            ...
            log.warn("Skipping RevertStatus creation — missing formId={}, instanceId={}, or bucketId={}",
     ...
     * from within the traversal — preserved verbatim from the original code.
     *
     * @param instanceId  the workflow instance ID
     * @param bucketId    the bucket identifier
