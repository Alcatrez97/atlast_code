...
public class TraversalContext {
    ...
    /** The live execution context (key → value) for SpEL evaluation. */
    public Map<String, Object> context;

    /** Nodes that caused the traversal to pause (BUCKET, WAIT_EVENT, …). */
    public List<WorkflowNodeDto> suspendedNodes;

    /**
     * In-memory task status cache: nodeId → "COMPLETED" | "SKIPPED" | "WAITING" | …
