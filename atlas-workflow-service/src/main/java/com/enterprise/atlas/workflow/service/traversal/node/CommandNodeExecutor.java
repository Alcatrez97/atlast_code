 ...
 *
 * <p><b>Sync mode</b>: executes the registered {@link com.enterprise.atlas.workflow.service.WorkflowCommand}
...
public class CommandNodeExecutor implements NodeExecutor {
    ...
    public interface CommandExecutorDelegate {
        Map<String, Object> execute(WorkflowNodeDto node,
                                    ...
                                    String instanceId,
                                    String contextId,
                                    com.enterprise.atlas.workflow.entity.WorkflowVersion version,
    ...
    private NodeExecutionResult handleAsyncCommand(WorkflowNodeDto node,
        ...
        if (alreadyCompleted) {
            // Resuming — the async work is done, pick up outputs and continue
        ...
        // First encounter — suspend and schedule async execution
