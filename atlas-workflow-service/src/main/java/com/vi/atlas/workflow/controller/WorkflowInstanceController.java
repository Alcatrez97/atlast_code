...
import com.vi.atlas.common.dto.WorkflowInstanceDto;
import com.vi.atlas.common.dto.RevertStatusDto;
...
public class WorkflowInstanceController {
    ...
    @GetMapping
    @Operation(summary = "Get all instances with pagination and filtering", description = "Retrieves a list of workflow stateful instances with page, size, workflowKey, status, search, and circleId filters")
    public ResponseEntity<Map<String, Object>> getAll(
        ...
        org.springframework.data.domain.Page<WorkflowInstance> instancePage = 
                repository.findAllWithFilters(workflowKey, status, search, circleIds, pageable);
