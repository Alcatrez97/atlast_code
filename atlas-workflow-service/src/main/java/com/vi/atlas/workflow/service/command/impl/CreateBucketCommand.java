...
public class CreateBucketCommand implements WorkflowCommand {
    ...
    public Map<String, Object> execute(Map<String, Object> input) throws Exception {
        ...
        String bucketId = getStringParam(input, "bucket", "bucketId");
        ...
        if (contextId != null && !contextId.isBlank()) {
            ...
            Optional<RevertStatus> existingPending = revertStatusRepository.findByWorkflowInstanceIdAndBucketIdAndStatus(instanceId, bucketId, com.vi.atlas.workflow.entity.RevertStepStatus.PENDING);
