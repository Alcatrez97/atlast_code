...
public interface ExecutionRepository extends JpaRepository<ExecutionLog, String> {
    ...
    Page<ExecutionLog> findByCircleIdOrderByStartedAtDesc(Integer circleId, Pageable pageable);

    Page<ExecutionLog> findByCircleIdInOrderByStartedAtDesc(java.util.List<Integer> circleIds, Pageable pageable);
