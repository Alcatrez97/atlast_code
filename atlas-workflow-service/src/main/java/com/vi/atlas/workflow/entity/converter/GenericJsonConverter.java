package com.vi.atlas.workflow.entity.converter;
...
/**
 * Reusable JSONâ†”String converters for generic Map and List structures stored as CLOBs.
 */
public class GenericJsonConverter {
    ...
    /** Converts Map<String,Object> â†” JSON CLOB */
    ...
    /** Converts List<Map<String,Object>> â†” JSON CLOB */
    @Converter(autoApply = false)
